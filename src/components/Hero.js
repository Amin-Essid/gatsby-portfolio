      ...
      <article className="hero-info">
        <div>
          <div className="underline"></div>
            ...
            For the last one you can see <Link to='/projects'>my projects</Link> to be sure that I got the knowledge, the skills and the quality of ideas. And if you want to really know me, and check my ability to write you can read what i wrote <Link to ='/about'>about me</Link>. Finally if you want to test my super power of speaking and communication feel free to <Link to ='/contact'>contact me</Link>. 
            </p>
